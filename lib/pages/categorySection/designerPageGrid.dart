...
class DesignerGridPage extends StatefulWidget {
  ...
  static const String routeName = "/DesignerGrid-page";
  final TextEditingController searchEdit;

  @override
  State<DesignerGridPage> createState() => _DesignerGridPageState();
}

class _DesignerGridPageState extends State<DesignerGridPage> {
