...
class DancerGridPage extends StatefulWidget {
  ...
  static const String routeName = "/dancerGrid-page";

  final TextEditingController searchEdit;

  @override
  State<DancerGridPage> createState() => _DancerGridPageState();
}

class _DancerGridPageState extends State<DancerGridPage> {
