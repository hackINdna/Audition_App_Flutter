...
class SAcceptedJobPage extends StatefulWidget {
  const SAcceptedJobPage({Key? key, required this.searchEdit})
      : super(key: key);

  static const String routeName = "/sacceptedJob-page";

  final TextEditingController searchEdit;

  @override
  State<SAcceptedJobPage> createState() => _SAcceptedJobPageState();
}

class _SAcceptedJobPageState extends State<SAcceptedJobPage> {
  ...
  Future<void> getStudioJobDetail_Studio(jobId) async {
    await otherService.getAcceptedStudioJobDetails(
