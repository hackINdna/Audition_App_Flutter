...
class SWriterProfilePage extends StatefulWidget {
  const SWriterProfilePage({Key? key}) : super(key: key);

  static const String routeName = "/swriterProfile-page";

  @override
  State<SWriterProfilePage> createState() => _SWriterProfilePageState();
}

class _SWriterProfilePageState extends State<SWriterProfilePage> {
